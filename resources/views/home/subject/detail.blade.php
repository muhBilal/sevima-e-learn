...
@section('content')
    <div class="lg:my-6 md:my-5 sm:my-4 my-3">
        ...
        <div class="max-w-screen-xl w-full mx-auto md:items-center md:justify-center md:flex-row py-5 mt-4 w-10/12">
            <div class="flex">

                @if ($posts->image)
                    <img src="{{ asset('storage/' . $posts->image) }}"
                        class=" lg:w-20 md:w-16 sm:w-14 w-12 lg:h-20 md:h-16 sm:h-14 h-12 bg-balt rounded-full px-2 py-2"
                        alt="">
                @else
                    <img src="{{ asset('/img/materi.png') }}"
                        class=" lg:w-20 md:w-16 sm:w-14 w-12 lg:h-20 md:h-16 sm:h-14 h-12 bg-balt rounded-full px-2 py-2"
                        alt="">
                @endif
                ...
                <div class="flex gap-10">
                    ...
                    <div class="bg-gray-300 h-[100%]" style="width: 4px">

                    </div>

                    <div class="w-11/12">
                        <h3 class="font-bold text-3xl text-gray-500">Chat</h3>
                        <div class="mt-5">
