<aside class="w-64" aria-label="Sidebar-10">
    <div class="overflow-y-auto fixed px-6 py-10 shadow-xl rounded dark:bg-gray-800 w-64" style="height: 100%">
       ...
       <ul class="space-y-2 text-gray mt-10">
          <li>
             <a href="/home" class="group my-3 flex items-center p-2 text-base font-normal text-gray-900 rounded-xl dark:text-white hover:bg-blue-500 hover:text-white dark:hover:bg-gray-700  {{ Request::is('home') ? 'active-nav-link text-white bg-blue-500' : '' }}">
